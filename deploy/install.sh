...
as_www php -r 'require $argv[1]."/src/bootstrap.php";$pdo=VazinCMS\Database::connection();if(!$pdo->query("SELECT 1")->fetchColumn()||VazinCMS\Version::current()!=="10.28.0")exit(1);' "$SITE_ROOT"
nginx -t
systemctl start nginx
