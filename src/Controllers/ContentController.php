...
final class ContentController{
 ...
 private function settingsMap():array{$map=[];foreach(Database::connection()->query('SELECT setting_key,setting_value FROM cms_settings')->fetchAll() as $row)$map[$row['setting_key']]=$row['setting_value'];return$map;}
