...
Current release: **10.28.0**. Upgrades are supported from 10.27.0 according to `vazin-package.json`. Use the release package and rollback procedure documented in the official support portal.
