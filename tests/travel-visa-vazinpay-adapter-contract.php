...
$raw='{"external_order_id":"travelvisa:TVORDER0001"}';$timestamp='1700000000';$headers=['X-VazinPay-Event'=>'invoice.paid','X-VazinPay-Delivery'=>'webhook-delivery-0001','X-VazinPay-Timestamp'=>$timestamp,'X-VazinPay-Signature'=>'v1='.hash_hmac('sha256',$timestamp.'.'.$raw,hash('sha256','contract-webhook'))];
