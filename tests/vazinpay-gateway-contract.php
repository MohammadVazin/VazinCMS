...
$raw='{"invoice_id":"inv_123456"}';$ts='1700000000';$headers=['X-VazinPay-Event'=>'invoice.paid','X-VazinPay-Delivery'=>'delivery-1','X-VazinPay-Timestamp'=>$ts,'X-VazinPay-Signature'=>'v1='.hash_hmac('sha256',$ts.'.'.$raw,hash('sha256','webhook-secret'))];
