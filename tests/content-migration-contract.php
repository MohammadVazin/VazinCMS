...
$wxr = '<?xml version="1.0"?><rss xmlns:content="http://purl.org/rss/1.0/modules/content/" xmlns:wp="http://wordpress.org/export/1.2/"><channel><item><title>آزمون</title><content:encoded><![CDATA[<script>alert(1)</script><p>متن سالم</p>]]></content:encoded><wp:post_id>42</wp:post_id><wp:post_name>safe-post</wp:post_name><wp:post_type>post</wp:post_type></item></channel></rss>';
